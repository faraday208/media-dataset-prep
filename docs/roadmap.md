...
| # | Tool | Tool sürümü | Meta UI | Notlar |
|---|---|---|---|---|
| 00 | media-organizer | **v0.5.0** ✓ | **wired** ✓ | CLI parity %100; recursive flat/tree, undo + cleanup, conflict modal |
| 01 | image-validator | — | stub | format/MIME validation; mostly automated |
...
✓ = bitti  ·  stub = "coming soon" placeholder  ·  — = bu projede sürüm bilgisi tutulmuyor (tool repo'sundan oku)
...
### 5. **01 — Validate** (düşük öncelik)
Çoğunlukla otomatik filter. UI değeri: hatalı dosyaların listesi + drop.
Basit step, CLI çıktı yeter.
...
## v0.2 milestone'ları (organizer tamamlandı, sıradaki paket)

- [ ] **02 duplicate** wire-up (gallery + pair-wise review)
